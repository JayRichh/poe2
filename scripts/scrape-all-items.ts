...
const ITEM_GROUPS: ItemGroup[] = [
  ...
  { 
    ...
    categories: ["Claws", "Daggers", "Wands", "One_Hand_Swords", "One_Hand_Axes", "One_Hand_Maces", "Sceptres", "Spears", "Flails"]
  },
  {
    name: "Two Handed Weapons",
    categories: ["Bows", "Staves", "Two_Hand_Swords", "Two_Hand_Axes", "Two_Hand_Maces", "Quarterstaves", "Crossbows", "Traps", "Fishing_Rods"]
  },
  ...
  { name: "Currency", categories: ["Stackable_Currency", "Distilled_Emotions", "Essence", "Splinter", "Catalyst"] },
  { name: "Waystones", categories: ["Waystones", "Map_Fragments", "Misc_Map_Items"] },
  { name: "Jewels", categories: ["Jewels"] },
  { 
    name: "Other", 
    categories: ["Hideout", "Strongbox", "Expedition_Logbook", "Hideout_Doodads", "Relics", "Inscribed_Ultimatum", 
                "Socketable", "Tablet", "Omen", "Trial_Coins", "Pinnacle_Keys"]
  }
];
