...
export function useBuilds() {
  ...
  const createBuild = useCallback(async (build: BuildInsert) => {
    setLoading(true)
    setError(null)
  ...
  const updateBuild = useCallback(async (id: string, updates: BuildUpdate) => {
    setLoading(true)
    setError(null)
  ...
  const getBuild = useCallback(async (id: string) => {
    setLoading(true)
    setError(null)
  ...
  const cloneBuild = useCallback(async (id: string, updates: Partial<BuildInsert> = {}) => {
    setLoading(true)
    setError(null)
