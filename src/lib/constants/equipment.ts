...
export const EQUIPMENT_DEFAULTS: Record<EquipmentSlot, EquipmentDefaults> = {
  ...
  helm: {
    ...
    properties: [{ name: "armor", value: 5, display: "5 Armor", type: "defence" }],
    requirements: [
      { name: "level", value: 1, display: "Level 1" },
  ...
  gloves: {
    ...
    properties: [{ name: "armor", value: 2, display: "2 Armor", type: "defence" }],
    requirements: [{ name: "level", value: 1, display: "Level 1" }],
