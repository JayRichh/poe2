        ...
        <div>
          ...
          <div className="space-y-2">
            <Text className="text-foreground-secondary text-balance">
              Calculate attack speed, recovery time, and reload time for different weapons and
              equipment combinations. Compare dual-wielding setups, analyze armor penalties, and
              optimize your build&apos;s speed.
            </Text>
