...
export async function generateMetadata(
  ...
  const metadata = await generateDynamicMetadata(
    ...
    parent,
    {
      ...
      description: "View and manage your Path of Exile 2 character builds, settings, and preferences. Track your build progress and share your creations with the community.",
      path: "/profile",
      openGraph: {
        type: "profile",
      },
