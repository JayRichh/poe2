  ...
  if (variant === "featured") {
    return (
      <Link 
        ...
        className="group relative overflow-hidden rounded-lg border border-border bg-card hover:bg-accent/5 transition-colors"
      >
        <div className="p-6 space-y-4">
          <div className="space-y-2">
            ...
            <Text variant="h4">{news.title}</Text>
      ...
      <div className="space-y-2">
        ...
        <div className="flex justify-between items-start gap-4">
          <div className="space-y-1">
            <Text variant="h4" className="line-clamp-1">{news.title}</Text>
            <Text variant="body" color="secondary" className="line-clamp-2">
              {news.description}
            </Text>
          </div>
          <ArrowRight className="w-5 h-5 text-accent mt-1 group-hover:translate-x-1 transition-transform" />
        </div>
      </div>
    </Link>
  );
