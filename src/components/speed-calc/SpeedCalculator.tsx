...
export function SpeedCalculator() {
  ...
  return (
    <div className="space-y-8">
      {/* Equipment Section */}
      <Card className="p-6">
        <Text variant="h3" className="mb-6">Equipment</Text>
      ...
      {/* Effects Section */}
      <Card className="p-6">
        <Text variant="h3" className="mb-6">Buffs & Effects</Text>
        <div className="space-y-6">
          {/* Athletics Slider */}
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <Text variant="h4">Athletics</Text>
              <Text variant="body" className="text-primary">{state.athletics}</Text>
            </div>
            <input
              type="range"
              min={0}
      ...
      {/* Results Section */}
      <Card className="p-6">
        <Text variant="h3" className="mb-6">Results</Text>
        <SpeedResults
          result={result}
