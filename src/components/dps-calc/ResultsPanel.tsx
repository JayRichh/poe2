...
export function ResultsPanel({ results }: ResultsPanelProps) {
  ...
  const getDamageTypeColor = (type: string): string => {
    switch (type.toLowerCase()) {
      case "physical":
        return "bg-damage-physical";
      case "lightning":
        return "bg-damage-lightning";
      case "fire":
        return "bg-damage-fire";
      case "cold":
        return "bg-damage-cold";
      case "chaos":
        return "bg-damage-chaos";
      default:
  ...
  const weapon2Bars: DamageTypeBar[] = [
    ...
    {
      type: "Lightning",
      value: sanitizeNumber(results.finalLightningDamage2),
      total: weapon2Total,
    },
