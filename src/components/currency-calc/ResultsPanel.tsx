          ...
          <div className="glass p-6 rounded-lg">
            <div className="flex items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-3xl font-semibold numeric">
                    {results.amount.toLocaleString(undefined, {
                  ...
                  <div className="text-sm text-muted-foreground mt-1">
                    Worth{" "}
                    {(results.amount * (fromCurrency?.value || 0)).toLocaleString(undefined, {
                      minimumFractionDigits: 0,
                      maximumFractionDigits: 0,
                    })}{" "}
                    chaos
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-3xl font-semibold numeric text-primary">
                    {results.convertedAmount.toLocaleString(undefined, {
                      minimumFractionDigits: 0,
                  ...
                  <div className="text-sm text-muted-foreground mt-1">
                    Worth{" "}
                    {(results.convertedAmount * (toCurrency?.value || 0)).toLocaleString(
                      undefined,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="glass p-4 rounded-lg">
              ...
              <div className="flex flex-col gap-2">
                <div className="text-sm">
                  1 {fromCurrency?.name} ={" "}
                  {fromCurrency?.value?.toLocaleString(undefined, {
                    minimumFractionDigits: 0,
                    maximumFractionDigits: 0,
                  })}{" "}
                  chaos
                ...
                <div className="text-sm">
                  1 {toCurrency?.name} ={" "}
                  {toCurrency?.value?.toLocaleString(undefined, {
                    minimumFractionDigits: 0,
                    maximumFractionDigits: 0,
                  })}{" "}
                  chaos
            ...
            <div className="glass p-4 rounded-lg">
              ...
              <div className="flex flex-col gap-2">
                <div className="text-sm">
                  1 {fromCurrency?.name} ={" "}
                  {results.rate.toLocaleString(undefined, {
                ...
                <div className="text-sm text-muted-foreground">
                  1 {toCurrency?.name} ={" "}
                  {(1 / results.rate).toLocaleString(undefined, {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2,
                  })}{" "}
                  {fromCurrency?.name}
